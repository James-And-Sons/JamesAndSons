-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'CUSTOMER', 'B2B_BUYER', 'B2B_APPROVER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "RFQStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'REVIEWING', 'APPROVED', 'REJECTED', 'CONVERTED_TO_ORDER');
...
CREATE TABLE "Product" (
    ...
    "d2cPrice" DOUBLE PRECISION NOT NULL,
    "b2bPrice" DOUBLE PRECISION NOT NULL,
    "isLed" BOOLEAN NOT NULL DEFAULT false,
    "luminousEfficacy" DOUBLE PRECISION,
    "cri" INTEGER,
    "hsnCode" TEXT,
    "gstRate" DOUBLE PRECISION NOT NULL DEFAULT 18.0,
    "bisCertification" TEXT,
    "images" TEXT[],
    "glbModelUrl" TEXT,
