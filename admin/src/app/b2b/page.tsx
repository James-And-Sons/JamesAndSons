    ...
    <div className="space-y-6">
      ...
      {pendingApps.length === 0 ? (
        <div className="bg-surface border border-border shadow-sm flex flex-col p-12 items-center justify-center min-h-[400px]">
          <h2 className="font-serif text-[24px] text-primary mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pendingApps.map((user) => (
            <div
              key={user.id}
              className="bg-surface border border-border p-6 relative flex flex-col hover:border-accent transition-colors"
            >
              ...
              <div className="mb-4">
                <h3 className="font-serif text-[20px] text-primary mb-1">
              ...
              <div className="space-y-3 mb-6 flex-1">
                ...
                {user.company?.billingAddress && (
                  <div>
                    ...
                    <p className="font-body text-[13px] text-secondary leading-relaxed line-clamp-2">
                      {user.company.billingAddress}
                    </p>
                  </div>
                )}
