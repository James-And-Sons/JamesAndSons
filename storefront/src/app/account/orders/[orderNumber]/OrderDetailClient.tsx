...
export default function OrderDetailClient({ order }: OrderDetailClientProps) {
  ...
  const isPaymentFailed =
    order.status === "PENDING" && !order.razorpayPaymentId;
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <i
                className={`ti ${STATUS_ICONS[order.status] || "ti-clock"}`}
            ...
            <a
              ...
              className="px-4 py-2 text-xs font-mono tracking-wider uppercase bg-[#C97E6A]/10 border border-[#C97E6A]/30 text-[#C97E6A] hover:bg-[#C97E6A]/20 transition-all rounded-full flex items-center gap-2 font-medium"
            >
            ...
            >
              <div>
                ...
                <div style={{ fontSize: "12px", color: "var(--text-muted)" }}>
                  Your payment was not confirmed. Please retry to complete your
                  order.
                </div>
              </div>
              <Link
                    ...
                    >
                      {STATUS_STEPS.map((step, idx) => {
                        ...
                        return (
                          <div
                            key={step}
                            className={`order-track-step ${isDone ? "done" : ""} ${isActive ? "active" : ""}`}
                            style={{
                              display: "flex",
                              alignItems: "center",
                              gap: "16px",
                          ...
                          >
                            ...
                            >
                              <i
                                className={`ti ${isDone ? "ti-check" : STATUS_ICONS[step]}`}
                                style={{
                                  fontSize: "12px",
                                  color:
                                    isDone || isActive
                  ...
                  {order.items.map((item, idx) => (
                    <div
                      ...
                      style={{
                        ...
                        alignItems: "flex-start",
                        paddingBottom:
                          idx < order.items.length - 1 ? "16px" : 0,
                        borderBottom:
              ...
              {isCancellable && (
                ...
                >
                  ...
                  >
                    ...
                    Cancellations are final and refunds (if any) are processed
                  ...
                  {order.awbNumber && (
                    ...
                    >
                      <i
                        ...
                        style={{ color: "var(--gold)", fontSize: "17px" }}
                      ></i>
                      Track Shipment
                    </a>
                  )}
