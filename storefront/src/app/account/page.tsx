...
export default async function AccountPage() {
  ...
  const isVerifiedB2B =
    dbUser?.role === "B2B_BUYER" || dbUser?.role === "B2B_APPROVER";
        ...
        <div className="md:hidden" style={{ paddingBottom: "40px" }}>
          ...
          <div
            ...
            style={{
              margin: "16px 14px 0",
              padding: "24px",
              background: "linear-gradient(150deg, #1a160a 0%, #0d0b06 100%)",
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  border: "1.5px solid rgba(196,160,90,0.35)",
                  display: "flex",
                  alignItems: "center",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              >
                {isB2B ? "B2B Client" : "Personal Account"} · Member since{" "}
              ...
              {quickLinks.map((link, i) => (
                ...
                >
                  ...
                  <i
                    ...
                    style={{ fontSize: "16px", color: "var(--border)" }}
                  ></i>
                </HapticLink>
              ))}
            </div>
          ...
          <div style={{ padding: "24px 16px 0" }}>
            ...
            {orders.length > 0 ? (
                ...
                {orders.map((order, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <i
                        className="ti ti-chevron-right"
                        style={{ fontSize: "14px", color: "var(--border)" }}
                      ></i>
                    </div>
                  </HapticLink>
                ))}
              ...
              <div
                style={{
                  borderRadius: "20px",
                  border: "0.5px dashed rgba(196,160,90,0.2)",
                  background: "var(--surface)",
                  padding: "32px 20px",
                  textAlign: "center",
                }}
            ...
            <form action="/auth/signout" method="post">
              <button
                style={{
                  ...
                  border: "0.5px solid rgba(200,80,60,0.2)",
                  color: "#C05040",
                  fontSize: "13px",
                  fontWeight: 500,
                  display: "flex",
        ...
        <div className="hidden md:block">
            ...
            >
              <div>
                ...
                >
                  ...
                  />
                  {isB2B
                    ? `B2B Client · ${dbUser?.company?.name || meta.company_name || ""}`
                    : "Personal Account"}
          ...
          >
            ...
            >
              ...
              >
                ...
                {isB2B && (dbUser?.company?.name || meta.company_name) && (
                  <InfoRow
                    label="Company"
                    value={dbUser?.company?.name || meta.company_name}
                    bold
                  />
                )}
                {isB2B && (dbUser?.company?.gstin || meta.gstin) && (
                  <InfoRow
                    label="GSTIN"
                    value={dbUser?.company?.gstin || meta.gstin}
                    mono
                  />
                )}
                {isB2B && (
              ...
              >
                ...
                >
                  Questions about an order or custom design? Our concierge team
                  is with you.
                </p>
                <a
                  href="mailto:connect@jamesandsons.in"
            ...
            >
              {isPendingB2B && (
                ...
                >
                  ...
                  >
                    Your application is being reviewed. Once approved you'll
                    unlock wholesale pricing, bulk RFQ submissions and priority
                    delivery for hospitality &amp; trade orders.
                  </p>
                </div>
              )}
                    ...
                    {orders.map((order) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <i
                            className="ti ti-chevron-right"
                            style={{ color: "var(--border)", fontSize: "14px" }}
                          ></i>
                        </div>
                      </Link>
                    ))}
                  ...
                  >
                    <Link href="/rfq" style={{ textDecoration: "none" }}>
                      <button
                        ...
                        style={{
                          padding: "12px 32px",
                          opacity: isPendingB2B ? 0.4 : 1,
                          cursor: isPendingB2B ? "not-allowed" : "pointer",
                        }}
                      >
          ...
          >
            ...
            >
              ...
              >
                &ldquo;System Default&rdquo; matches your device&rsquo;s dark or
                light preference automatically.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      <svg
        ...
        stroke="var(--gold)"
        strokeWidth="1"
        style={{ opacity: 0.35, marginBottom: "20px" }}
      >
