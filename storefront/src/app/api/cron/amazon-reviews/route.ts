...
import { dispatchAmazonReviewSolicitations } from '@/lib/integrations/amazon-reviews';
...
export async function GET(request: Request) {
  ...
  console.log('[Amazon Reviews Cron] Initiating daily review solicitation run...');
  ...
  try {
    ...
    console.error('[Amazon Reviews Cron] Fatal error during dispatch run:', err);
    return NextResponse.json(
