...
export default function CheckoutPageInner({
  ...
  const { items, total, clearCart, appliedCoupon, discountedTotal } =
    useCartStore();
  ...
  useEffect(() => {
    if (showGst && form.gstin.trim().length >= 15) {
      const res = validateGstinFormat(form.gstin);
      ...
      const checkUc = async () => {
        try {
          const res = await fetch(
            `/api/urbancompany/pincodes?code=${form.pincode}`,
          );
          if (res.ok) {
  ...
  const grandTotal =
    ...
    (shipping || 0) +
    installationFee -
    (applyShippingSavings && shippingDiscount > 0 ? shippingDiscount : 0);
        ...
        handler: async function (response: any) {
          try {
            ...
            if (verifyRes.success) {
              ...
              setOrderError(
                verifyRes.error || "Payment signature verification failed.",
              );
              setLoading(false);
            }
          } catch (err) {
  ...
  if (step === 3) {
    return (
      ...
      >
        ...
        >
          A GST invoice and tracking info will be sent to your email. Our
          concierge team will reach out to coordinate delivery.
        </p>
        <div
          style={{
            display: "flex",
  ...
  if (paymentFailed) {
    return (
      ...
      >
        ...
        >
          Your selection is still reserved for you. Please choose a recovery
          option below to finalize your order.
        </p>
        ...
        >
          ...
          {paymentLink && (
            ...
            >
              ...
              >
                You can also pay later using this link on your mobile phone.
              </p>
            </div>
          )}
        </div>
      ...
      >
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                padding: "18px 24px",
                background:
                  step === s.n ? "rgba(201,168,76,0.08)" : "transparent",
                borderRight: s.n === 1 ? "1px solid var(--border)" : "none",
              ...
              >
                <div
                  style={{
                    ...
                    height: "32px",
                    borderRadius: "50%",
                    border: `1px solid ${step >= s.n ? "var(--gold)" : "var(--border)"}`,
          ...
          >
            ...
            <div className="form-grid">
              {[
                ...
                <div
                  key={f.key}
                  style={{ gridColumn: f.key === "phone" ? "auto" : "auto" }}
                >
                  <label
                    style={{
                      fontFamily: "var(--font-mono)",
              ...
              <div>
                ...
                >
                  Pincode <span style={{ color: "var(--red)" }}>*</span>
                </label>
                <input
                  required
            ...
            <div style={{ padding: "8px 0" }}>
              ...
              {showGst && (
                <div
                  className="form-grid"
                  style={{ marginTop: "20px", animation: "fadeIn 0.3s ease" }}
                >
                  <div>
                    <label
                      style={{
                    ...
                    <input
                      placeholder="15-digit GST Number (e.g. 09AABCJ8243A1ZX)"
                      value={form.gstin}
                      onChange={(e) =>
                      ...
                      >
                        {gstValidation.isValid ? (
                          <span style={{ color: "#34d399" }}>
                            ✓ Verified GSTIN ({gstValidation.stateName} • PAN:{" "}
                            {gstValidation.pan})
                          </span>
                        ) : (
                          <span style={{ color: "#f87171" }}>
                            ✕{" "}
                            {gstValidation.error ||
                              "Invalid 15-digit GSTIN structure"}
                          </span>
                        )}
                      </div>
                    )}
            ...
            <button
              onClick={async () => {
                if (
                  ...
                  setOrderError(
                    "Please fill in all delivery details before continuing.",
                  );
                  return;
                }

                // Strict GSTIN Validation if requested
                if (showGst && form.gstin.trim()) {
                  const gstCheck = validateGstinFormat(form.gstin);
                  if (!gstCheck.isValid) {
                    setOrderError(`Invalid GSTIN: ${gstCheck.error}`);
                    return;
                  }
                }
                ...
                if (form.address.trim().length < 5) {
                  setOrderError(
                    "Please enter a more detailed street address (minimum 5 characters).",
                  );
                  return;
                }
                ...
                try {
                  ...
                  if (check.serviceable) {
                    ...
                    setOrderError(
                      `Sorry, we currently do not deliver to pincode ${form.pincode}.`,
                    );
                  }
                } catch (e) {
                  setOrderError(
                    "Unable to verify delivery pincode at this time.",
                  );
                } finally {
                  setLoading(false);
                }
        ...
        {step === 2 && (
          ...
          >
                  ...
                  >
                    ...
                    >
                      <strong style={{ color: "#fff" }}>
                        {form.companyName || "Company Name Not Provided"}
                      </strong>
                      <br />
                      GSTIN:{" "}
                      <span
                ...
                {false && ucServiceable === true && (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <label
                        htmlFor="uc-installation-checkbox"
                        style={{
                          fontFamily: "var(--font-serif)",
                          fontSize: "16px",
                          color: "var(--cream)",
                    ...
                    {bookInstallation && (
                      ...
                      >
                            ...
                            {ucSlots.map((slot) => (
                              <button
                                ...
                                style={{
                                  ...
                                  cursor: "pointer",
                                  fontWeight:
                                    selectedUcSlot === slot.date ? 600 : 400,
                                  whiteSpace: "nowrap",
                                  transition: "all 0.3s ease",
                                }}
                              >
                        ...
                        {selectedUcSlot && (
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setSelectedUcTime(e.target.value)
                              }
                              style={{
                                width: "100%",
                                background: "var(--void)",
                        ...
                        >
                          {subtotal > 50000
                            ? "✨ Free Premium Installation Applied"
                            : "⚡ ₹1,499 service charge will apply"}
                        </div>
                      </div>
                    )}
                  </div>
                ...
                {false && ucServiceable === false && (
                  ...
                  >
                    ...
                    >
                      <span>⚠️</span>
                      <span>
                        Chandelier Installation is not available at pincode{" "}
                        {form.pincode}.
                      </span>
                    </div>
                  </div>
            ...
            >
              🔒 Secure payment powered by Razorpay. All major UPI, Cards, and
              Net Banking apps are supported.
            </div>
            ...
            >
              {items.map((item) => (
                ...
                >
                  ...
                  >
                    {renderPrice(
                      (item.product.d2cPrice + (item.warranty?.price || 0)) *
                        item.quantity,
                    )}
                  </span>
                </div>
                  ...
                  style={{
                    color:
                      shipping === 0 || appliedCoupon?.freeShipping
                        ...
                        : "var(--cream)",
                    fontWeight:
                      shipping === 0 || appliedCoupon?.freeShipping ? 600 : 400,
                  }}
                >
                  {appliedCoupon?.freeShipping
                    ? "FREE"
              ...
              {shippingDiscount > 0 && (
                <div
                  style={{
                    margin: "8px 0",
                    padding: "14px 16px",
                    background: applyShippingSavings
                      ? "rgba(90,196,122,0.06)"
                      : "rgba(201,168,76,0.06)",
                    border: applyShippingSavings
                      ? "1px solid rgba(90,196,122,0.2)"
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {applyShippingSavings ? (
                        <>
                          You saved{" "}
                          <strong>{formatPrice(shippingDiscount)}</strong> on
                          this order.
                        </>
                      ) : (
                        <>
                          You have a special discount of{" "}
              ...
              {bookInstallation && (
                ...
                >
                  ...
                  <span
                    style={{
                      color:
                        installationFee === 0 ? "var(--green)" : "var(--cream)",
                      fontWeight: installationFee === 0 ? 600 : 400,
                    }}
                  >
                    {installationFee === 0
                      ? "FREE"
                      : renderPrice(installationFee)}
                  </span>
                </div>
              )}
