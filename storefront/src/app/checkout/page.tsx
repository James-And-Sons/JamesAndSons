...
function CheckoutPageInner() {
  ...
  if (items.length === 0 && step !== 3) {
    return (
      <div style={{ textAlign: 'center', padding: '80px 20px' }}>
        ...
        <a href="/collections" className="btn-primary" style={{ textDecoration: 'none', padding: '12px 32px' }}>Browse Collections</a>
      </div>
    );
  }
    ...
    return (
      <div style={{ textAlign: 'center', padding: '80px 20px', maxWidth: '520px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/account" className="btn-primary" style={{ textDecoration: 'none', padding: '12px 28px' }}>View My Orders</a>
          <a href="/collections" className="btn-outline" style={{ textDecoration: 'none', padding: '12px 28px' }}>Continue Shopping</a>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '48px 40px', display: 'grid', gridTemplateColumns: '1fr 380px', gap: '2px', alignItems: 'start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
        ...
        {step === 1 && (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', padding: '28px' }}>
            ...
            <button 
              ...
              style={{ marginTop: '24px', padding: '14px 32px', letterSpacing: '0.15em', width: '100%' }}
            >
              Continue to Payment →
            </button>
          </div>
        ...
        {step === 2 && (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', padding: '28px' }}>
            ...
            <button onClick={handlePayment} disabled={loading} className="btn-primary" style={{ width: '100%', padding: '14px 32px', letterSpacing: '0.15em', opacity: loading ? 0.7 : 1 }}>
...
// Wrapper because Navigation is async server component
export default function CheckoutPage() {
  return (
    <main style={{ paddingTop: '64px', minHeight: '100vh', background: 'var(--obsidian)' }}>
      <div style={{ background: 'var(--void)', borderBottom: '1px solid var(--border)', padding: '32px 40px' }}>
