          ...
          <div style={{ padding: '20px 24px 0' }}>
            ...
            {userReviews.length >= 50 && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' }}>
                ...
                <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>({userReviews.length} Client Reviews)</span>
              </div>
            )}
              ...
              <div>
                ...
                {userReviews.length >= 50 && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                    ...
                    <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>({userReviews.length} Client Testimonials)</span>
                  </div>
                )}
