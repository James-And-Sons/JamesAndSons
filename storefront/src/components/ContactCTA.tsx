...
export default function ContactCTA() {
  return (
    <section
      ...
      style={{
        padding: '80px 40px',
        background: 'linear-gradient(135deg, var(--surface) 0%, var(--obsidian) 100%)',
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              From bespoke chandeliers for heritage estates to large-scale hospitality projects —
              our design concierge team is here to bring your vision to life.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            >
              <div style={{ width: '44px', height: '44px', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <i className="ti ti-phone" style={{ fontSize: '18px', color: 'var(--gold)' }} />
              </div>
              <div>
            ...
            >
              <div style={{ width: '44px', height: '44px', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <i className="ti ti-mail" style={{ fontSize: '18px', color: 'var(--gold)' }} />
              </div>
              <div>
