...
export default function NewArrivalsSection({ products }: { products: Product[] }) {
  ...
  return (
    <section
      ...
      style={{
        padding: '80px 40px',
        background: 'radial-gradient(ellipse at 50% 0%, rgba(201,168,76,0.06) 0%, var(--background) 70%)',
        ...
        >
          {products.slice(0, 4).map((product) => {
            ...
            const discountPercent = hasDiscount
              ? Math.round(((product.mrp - product.d2cPrice) / product.mrp) * 100)
              : 0;
              ...
              >
                ...
                <Link
                  ...
                  style={{
                    ...
                    height: '260px',
                    width: '100%',
                    background: 'linear-gradient(145deg, #181410 0%, #110d09 100%)',
                    overflow: 'hidden',
                    display: 'block',
                  }}
                >
                  {thumbnail ? (
                    ...
                    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <i className="ti ti-lamp" style={{ fontSize: '54px', color: 'var(--gold)', opacity: 0.2 }} />
                    </div>
                  )}
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: 'linear-gradient(to top, rgba(10,9,5,0.6) 0%, transparent 40%)',
                      pointerEvents: 'none',
                    }}
                  />
                </Link>
