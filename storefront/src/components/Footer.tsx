      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ lineHeight: 1.8 }}>{companyDesc}</p>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              ...
              <li>
                <Link href="/spaces" className="footer-link">
                  Spaces
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            >
              <Link href="/account/tickets" className="btn-support-ticket">
                {t("common.cta.raise_ticket", "Raise a Ticket")}
              </Link>
              {config.featureFlags.enableNdrPortal && (
                <Link
                  href="/returns"
        ...
        >
          <p style={{ margin: 0 }}>
            {t(
              ...
              { year: currentYear, brandName },
            )}
          </p>
          <div style={{ display: "flex", gap: "16px" }}>
            {config.brand.social?.instagram && (
              <a
                href={config.brand.social.instagram}
                target="_blank"
            ...
            {config.brand.social?.pinterest && (
              <a
                href={config.brand.social.pinterest}
                target="_blank"
                rel="noopener noreferrer"
                className="footer-link"
                style={{ textDecoration: "none" }}
            ...
            {config.brand.social?.linkedin && (
              <a
                href={config.brand.social.linkedin}
                target="_blank"
                rel="noopener noreferrer"
                className="footer-link"
                style={{ textDecoration: "none" }}
