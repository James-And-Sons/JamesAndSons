    ...
    <html>
      ...
      <body>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th style="text-align: right;">Unit Price (${brand.currencySymbol})</th>
              <th style="text-align: right;">Amount (${brand.currencySymbol})</th>
            </tr>
          </thead>
          <tbody>
            ${itemsHtml}
        ...
        <table class="totals-table">
          <tr>
            <td>Subtotal:</td>
            <td style="text-align: right; font-family: monospace;">${brand.currencySymbol}${subtotal.toLocaleString("en-IN")}</td>
          </tr>
          ${
          ...
          <tr>
            ...
            <td style="text-align: right; font-family: monospace; color: #c0392b;">-${brand.currencySymbol}${data.discountAmount.toLocaleString("en-IN")}</td>
          </tr>
          `
              : ""
          }
          ${
            data.taxAmount > 0
              ? `
          <tr>
            <td>GST (${brand.defaultGstRate}%):</td>
            <td style="text-align: right; font-family: monospace;">${brand.currencySymbol}${data.taxAmount.toLocaleString("en-IN")}</td>
          </tr>
          `
              : ""
          }
          ...
          <tr>
            ...
            <td style="text-align: right; font-family: monospace;">${brand.currencySymbol}${data.shippingAmount.toLocaleString("en-IN")}</td>
          </tr>
          `
              : ""
          }
          <tr class="grand-total">
            <td>Total Offered:</td>
            <td style="text-align: right; font-family: monospace;">${brand.currencySymbol}${data.totalAmount.toLocaleString("en-IN")}</td>
          </tr>
        </table>

        <div class="footer-terms">
          <strong>Terms & Conditions:</strong><br>
          1. All prices are in ${brand.currencyCode}. Goods once sold are subject to ${brand.name} standard warranty rules.<br>
          2. Delivery lead time starts after receipt of advance payment and technical sign-off.<br>
          3. For assistance, contact ${brand.supportEmail}.
        </div>
